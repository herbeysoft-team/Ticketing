    ...
    >
      ...
      <FlatList
        ...
        renderItem={({ item }) => (
          ...
          >
            {seats.includes(item) ? (
              <Text style={{ backgroundColor: "#ffc40c", padding: 8, textAlign:"center" }}>
                {item}
              </Text>
            ) : occupied.includes(item) ? (
              <Text style={{ backgroundColor: "#989898", padding: 8, textAlign:"center" }}>
                {item}
              </Text>
            ) : (
              <Text style={{ padding: 8, textAlign:"center" }}>{item}</Text>
            )}
          </Pressable>
        )}
        ListFooterComponent={
